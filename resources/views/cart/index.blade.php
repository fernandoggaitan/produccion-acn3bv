                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('cart.store') }}" method="POST">
                                        ...
                                        <input @disabled( isset($cart[$item->id]) ) type="number" min="1" name="cantidad" max="100"
                                            class="form-control w-25 mb-3" placeholder="Ingrese la cantidad"
                                            value="{{ isset($cart[$item->id]) ? $cart[$item->id]['cantidad'] : 1 }}" />
                                        <button @disabled( isset($cart[$item->id]) ) class="btn btn-success" type="submit">
